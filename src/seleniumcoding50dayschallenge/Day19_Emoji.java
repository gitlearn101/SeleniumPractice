...
public class Day19_Emoji {
	...
	public void EmojiRating() throws InterruptedException {
		...
		List<WebElement> starsRating = driver
				.findElements(By.xpath("//label[contains(@class,'star-') and contains(@class,'fa-star')]"));
		...
		switch (input) {
		case 1:
			WebElement star1_emoji = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.cssSelector("img[src='emojis/emoji-" + input + ".png']")));
			...
			break;
		case 2:
			WebElement star2_emoji = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.cssSelector("img[src='emojis/emoji-" + input + ".png']")));
			...
			break;
		case 3:
			WebElement star3_emoji = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.cssSelector("img[src='emojis/emoji-" + input + ".png']")));
			...
			break;
		case 4:
			WebElement star4_emoji = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.cssSelector("img[src='emojis/emoji-" + input + ".png']")));
			...
			break;
		case 5:
			WebElement star5_emoji = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.cssSelector("img[src='emojis/emoji-" + input + ".png']")));
